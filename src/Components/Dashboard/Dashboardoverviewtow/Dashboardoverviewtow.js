                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="asets/img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="asets/img/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    <form action="#" method="post">
                                        ...
                                        <div>
                                            <textarea class="textarea" placeholder="Message" style={{width: '100%', height: '125px', fontSize: '14px', lineHeight: '18px', border: '1px solid #dddddd', padding: '10px'}}></textarea>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right box-tools">                                        
                                        ...
                                        <button class="btn btn-primary btn-sm pull-right" data-widget='collapse' data-toggle="tooltip" title="Collapse" style={{marginRight:' 5px'}}><i class="fa fa-minus"></i></button>
                                    </div>
                                    {/* <!-- /. tools --> */}
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    {/* <!-- chat item --> */}
                                    <div class="item">
                                        <img src="asets/img/avatar.png" alt="user image" class="online"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    {/* <!-- chat item --> */}
                                    <div class="item">
                                        <img src="asets/img/avatar2.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    {/* <!-- chat item --> */}
                                    <div class="item">
                                        <img src="asets/img/avatar3.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
...
export default Dashboardoverviewtow;
...
const AddCategory = () => {
    ...
    const [photoURL, setPhotoURL] = useState("");
        ...
        axios.post(
                "http://localhost:7070/api/category/create",
                userinfo
              )
          .then(res =>res.json())
    ...
    return (
        ...
        <Box className={`${styles.topContainer}`} sx={{ display: "flex", my: 3 }}>
            ...
            <Typography>
                ...
                <br /> <span style={{ color: "#969494" }}>All Category</span>
            </Typography>
        </Box>
                        ...
                        {/* button  */}
                                <div className="row gx-3 mb-3">
                                    <div className="col-lg-12 col-md-12 col-sm-12 col-12 mt-1">
                                        <div className="p-3">
                                            <div>
                                            <FormLabel id="demo-row-radio-buttons-group-label">Is Fetured</FormLabel>
      <RadioGroup
        row
      ...
      <Table sx={{  }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">Fetured</TableCell>
        ...
        <TableBody>
          {/* {rows.map((row) => ( */}
            ...
            >
              ...
              <TableCell align="right">15 Sep 2021</TableCell>
              <TableCell align="right"> 
              <ToggleOffIcon sx={{color:"red", fontSize:'40px'}} />
              </TableCell>
              <TableCell align="right"> <button>edit</button> <button>delet</button> </TableCell>

                        ...
                        <Grid item md={10} sx={{ background: '#F8F5FF', borderRadius: 5, p: 4, zIndex: 9, mt: 10 }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-around', mt: 4 }}>
                                ...
                                <Box className="contactFormBox" sx={{ display: "flex", flexWrap: 'wrap', justifyContent: "center", columnGap: 5, rowGap: 3 }}>
                                    <Button className='socialMedia' style={{ background: "#1768D4", color: "#fff", padding: '8px 25px' }}> <a target="_blank" href="" > <FaFacebookF style={{marginRight:"5px"}}/> Facebook </a>  </Button>

                                    <Button className='socialMedia' style={{ background: "#1EBCE9", color: "#fff", padding: '8px 25px', margin: '0 20px' }}> <a href=""> <FaTwitter style={{marginRight:"5px"}}/>Twitter</a>   </Button>

                                    <Button className='socialMedia'   style={{ background: "#D63127", color: "#fff", padding: '8px 25px' }} > <a target="_blank" href=""><BsYoutube style={{marginRight:"5px"}} />Youtube </a> </Button>
                                </Box>

...
const ContactForm = () => {
  ...
  return (
    <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Grid container spacing={2}>
            ...
            <Grid item md={10} xs={12}>
              ...
              {!loading ? (
                <Button className="formSendBtn" type="submit" style={subButton}>
                  SEND
                </Button>
              ) : (
                <Button type="submit" style={subButton}>
                  loading...
                </Button>
              )}
            </Grid>
            ...
            >
              ...
              >
                <Avatar
                  sx={firstAvatar}
                  alt="user image"
                  src="https://i.ibb.co/vm49bq8/r-img3.png"
                />
                <Avatar
                  sx={firstAvatar}
                  alt="Travis Howard"
                  src="https://i.ibb.co/mFND2Sp/img2.png"
                />
              </Box>
              ...
              >
                <Avatar
                  sx={firstAvatar}
                  alt="user image"
                  src="https://i.ibb.co/QXhqJ82/r-img1.png"
                />
              ...
              >
                ...
                <Avatar
                  sx={secondAvatar}
                  alt="user image"
                  src="https://i.ibb.co/0CHGDKx/img1.png"
                />
              </Box>
            </Grid>
          </Grid>
      ...
      <Box>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d116834.00977805836!2d90.34928591682576!3d23.78077774431569!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!5e0!3m2!1sen!2sbd!4v1647269650262!5m2!1sen!2sbd"
          width="100%"
          height="430"
          title="googlemap"
          style={{ border: "none", marginTop: "-135px", zIndex: "-1000" }}
          allowfullscreen=""
          loading="lazy"
        ></iframe>
      </Box>

                ...
                <Grid
                    ...
                    <Grid
                        ...
                        <Box className={classes.text} >
                            ...
                            <Typography
                                variant='body1'
                                gutterBottom
                            > Our provider will provide their service to user. After order user can asked their query to provider. Service A to Z will keep small amount of cost from provider
                            </Typography>
                            <div  style={{ textDecoration: "none" }}>
                                <Button
                    ...
                    <Grid
                        ...
                        <Box className='step-section step-1'>
                            <Box className={classes.text2}>
                                <Typography
                                    sx={{ fontWeight: 'bold', p: 1 }}>Choose What To Do
                                </Typography>
                            </Box>
                    ...
                    <Grid
                        ...
                        <Box className='step-section step-2'>
                            <Box className={classes.text2}>
                                <Typography
                                    sx={{ fontWeight: 'bold', p: 1 }}>Find What You Want</Typography>
                            </Box>
                            <Typography sx={{ p: 1 }}>
                    ...
                    <Grid
                        ...
                        <Box className='step-section step-3'>
                            <Box className={classes.text2}>
                                <Typography sx={{ fontWeight: 'bold', p: 1 }} >Amazing Places</Typography></Box>
                            <Typography sx={{ p: 1, }}>

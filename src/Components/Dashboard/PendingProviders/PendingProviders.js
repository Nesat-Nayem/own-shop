        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    setLoading(true);
                    axios.put(`https://dry-sea-00611.herokuapp.com/addprovider/approveprovider?uid`).then(res => {
                        axios.post(`https://dry-sea-00611.herokuapp.com/addprovider/addproviderkey/${parentId}`, 

    ...
    <Container className="mt-5">
      ...
      >
          ...
          {loading ? (
            <>
              {[...new Array(4)].map((ske, index) => (
                <SwiperSlide key={index} spacing={1}>
                  <Stack>
                    <Skeleton
                      animation="wave"
                      variant="rectangular"
            ...
            providers.map((singleData) => (
              <SwiperSlide key={singleData._id}>
                <AllProviderChild provider={singleData}></AllProviderChild>
              </SwiperSlide>
            ))
          )}
        </Swiper>
        ...
        >
          ...
          <IconButton onClick={() => my_swiper.slideNext()} sx={btnStyle}>
            <ArrowForwardIcon
              sx={{ color: "rgb(255, 94, 20)" }}
            ></ArrowForwardIcon>
          </IconButton>
        </Stack>
      </Box>
